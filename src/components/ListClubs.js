...
export default class ListClubs extends Component {
  ...
  componentDidMount() {
    fetch(
      `https://apiv2.apifootball.com/?action=get_countries&APIkey=5f990ce48ebc7388ba775b57240a09e34a74f3ac19ce1d51ee35839a1e2ce4e2`
    )
              ...
              {this.state.ligues.map((ligue, index) => (
                ...
                >
                  <div className="img-frame">
                    <img src={ligue.country_logo} alt={ligue.country_name} />
                  </div>
                  <p className="w-100">{ligue.country_name}</p>
                </li>
              ))}
            </ul>
          </div>
