...
export default function ListTeams({ league }) {
	...
	useEffect(() => {
		GETapi(
			`https://apiv2.apifootball.com/?action=get_teams&league_id=149&APIkey=5f990ce48ebc7388ba775b57240a09e34a74f3ac19ce1d51ee35839a1e2ce4e2`
	...
	return (
		<section className="sec--teams">
			<h2>Teams</h2>
			<p>
				Look all the teams in the league, click on team to see more info
				about it
			</p>
